...
public class BeautyPlanTool {
  /*  //美颜 SDK
   static   PGPrettifySDK prettifySDK = new PGPrettifySDK(ConversationApplication.getContext());
    ...
    private static float PINK_VALUE = 1.0f;    //美颜 pink  取值范围：0f-1.0f
    private static float WHITE_VALUE = 1.0f;  //美颜 white 取值范围：0f-1.0f
    private static float REDDEN_VALUE = 1.0f;  //美颜 red   取值范围：0f-1.0f
    private static int SOFTEN_VALUE = 100;     //美颜程度    取值范围：0-100
